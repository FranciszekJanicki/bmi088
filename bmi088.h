...
bmi088_err_t bmi088_set_acc_softreset_reg(bmi088_t const* bmi088, bmi088_acc_softreset_reg_t const* reg);

bmi088_err_t bmi088_set_acc_pwr_ctrl_reg(bmi088_t const* bmi088, bmi088_acc_pwr_ctrl_reg_t const* reg);
bmi088_err_t bmi088_get_acc_pwr_ctrl_reg(bmi088_t const* bmi088, bmi088_acc_pwr_ctrl_reg_t* reg);

bmi088_err_t bmi088_set_acc_pwr_conf_reg(bmi088_t const* bmi088, bmi088_acc_pwr_conf_reg_t const* reg);
bmi088_err_t bmi088_get_acc_pwr_conf_reg(bmi088_t const* bmi088, bmi088_acc_pwr_conf_reg_t* reg);

bmi088_err_t bmi088_set_acc_self_test_reg(bmi088_t const* bmi088, bmi088_acc_self_test_reg_t const* reg);
bmi088_err_t bmi088_get_acc_self_test_reg(bmi088_t const* bmi088, bmi088_acc_self_test_reg_t* reg);

bmi088_err_t bmi088_set_acc_int_map_data_reg(bmi088_t const* bmi088, bmi088_acc_int_map_data_reg_t const* reg);
bmi088_err_t bmi088_get_acc_int_map_data_reg(bmi088_t const* bmi088, bmi088_acc_int_map_data_reg_t* reg);

bmi088_err_t bmi088_set_acc_int2_io_ctrl_reg(bmi088_t const* bmi088, bmi088_acc_int2_io_ctrl_reg_t const* reg);
bmi088_err_t bmi088_get_acc_int2_io_ctrl_reg(bmi088_t const* bmi088, bmi088_acc_int2_io_ctrl_reg_t* reg);

bmi088_err_t bmi088_set_acc_int1_io_ctrl_reg(bmi088_t const* bmi088, bmi088_acc_int1_io_ctrl_reg_t const* reg);
bmi088_err_t bmi088_get_acc_int1_io_ctrl_reg(bmi088_t const* bmi088, bmi088_acc_int1_io_ctrl_reg_t* reg);

bmi088_err_t bmi088_set_acc_fifo_config_reg(bmi088_t const* bmi088, bmi088_acc_fifo_config_reg_t const* reg);
bmi088_err_t bmi088_get_acc_fifo_config_reg(bmi088_t const* bmi088, bmi088_acc_fifo_config_reg_t* reg);

bmi088_err_t bmi088_set_acc_fifo_wtm_reg(bmi088_t const* bmi088, bmi088_acc_fifo_wtm_reg_t const* reg);
bmi088_err_t bmi088_get_acc_fifo_wtm_reg(bmi088_t const* bmi088, bmi088_acc_fifo_wtm_reg_t* reg);

bmi088_err_t bmi088_set_acc_fifo_downs_reg(bmi088_t const* bmi088, bmi088_acc_fifo_downs_reg_t const* reg);
...
bmi088_err_t bmi088_set_gyro_fifo_config_reg(bmi088_t const* bmi088, bmi088_gyro_fifo_config_reg_t const* reg);
bmi088_err_t bmi088_get_gyro_fifo_config_reg(bmi088_t const* bmi088, bmi088_gyro_fifo_config_reg_t* reg);

bmi088_err_t bmi088_set_gyro_self_test_reg(bmi088_t const* bmi088, bmi088_gyro_self_test_reg_t const* reg);
bmi088_err_t bmi088_get_gyro_self_test_reg(bmi088_t const* bmi088, bmi088_gyro_self_test_reg_t* reg);

bmi088_err_t bmi088_set_gyro_fifo_ext_int_s_reg(bmi088_t const* bmi088, bmi088_gyro_fifo_ext_int_s_reg_t const* reg);
bmi088_err_t bmi088_get_gyro_fifo_ext_int_s_reg(bmi088_t const* bmi088, bmi088_gyro_fifo_ext_int_s_reg_t* reg);

bmi088_err_t bmi088_set_gyro_fifo_wtm_en_reg(bmi088_t const* bmi088, bmi088_gyro_fifo_wm_en_reg_t const* reg);
...
bmi088_err_t bmi088_set_gyro_int_ctrl_reg(bmi088_t const* bmi088, bmi088_gyro_int_ctrl_reg_t const* reg);
bmi088_err_t bmi088_get_gyro_int_ctrl_reg(bmi088_t const* bmi088, bmi088_gyro_int_ctrl_reg_t* reg);

bmi088_err_t bmi088_set_gyro_softreset_reg(bmi088_t const* bmi088, bmi088_gyro_softreset_reg_t const* reg);
...
bmi088_err_t bmi088_set_gyro_bandwidth_reg(bmi088_t const* bmi088, bmi088_gyro_bandwidth_reg_t const* reg);
