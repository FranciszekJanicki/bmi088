...
static bmi088_err_t bmi088_acc_bus_initialize(bmi088_t const* bmi088)
{
    return bmi088->interface.acc_bus_initialize
               ? bmi088->interface.acc_bus_initialize(bmi088->interface.acc_bus_user)
               : BMI088_ERR_NULL;
}
...
static bmi088_err_t bmi088_acc_bus_deinitialize(bmi088_t const* bmi088)
{
    return bmi088->interface.acc_bus_deinitialize
               ? bmi088->interface.acc_bus_deinitialize(bmi088->interface.acc_bus_user)
               : BMI088_ERR_NULL;
}
                                              ...
                                              size_t data_size)
{
    return bmi088->interface.acc_bus_write_data
               ? bmi088->interface.acc_bus_write_data(bmi088->interface.acc_bus_user,
                                                      address,
                                                      data,
                                                      data_size)
               : BMI088_ERR_NULL;
                                             ...
                                             size_t data_size)
{
    return bmi088->interface.acc_bus_read_data
               ? bmi088->interface.acc_bus_read_data(bmi088->interface.acc_bus_user,
                                                     address,
                                                     data,
                                                     data_size)
               : BMI088_ERR_NULL;
...
static bmi088_err_t bmi088_gyro_bus_initialize(bmi088_t const* bmi088)
{
    return bmi088->interface.gyro_bus_initialize
               ? bmi088->interface.gyro_bus_initialize(bmi088->interface.gyro_bus_user)
               : BMI088_ERR_NULL;
}
...
static bmi088_err_t bmi088_gyro_bus_deinitialize(bmi088_t const* bmi088)
{
    return bmi088->interface.gyro_bus_deinitialize
               ? bmi088->interface.gyro_bus_deinitialize(bmi088->interface.gyro_bus_user)
               : BMI088_ERR_NULL;
}
                                               ...
                                               size_t data_size)
{
    return bmi088->interface.gyro_bus_write_data
               ? bmi088->interface.gyro_bus_write_data(bmi088->interface.gyro_bus_user,
                                                       address,
                                                       data,
                                                       data_size)
               : BMI088_ERR_NULL;
                                              ...
                                              size_t data_size)
{
    return bmi088->interface.gyro_bus_read_data
               ? bmi088->interface.gyro_bus_read_data(bmi088->interface.gyro_bus_user,
                                                      address,
                                                      data,
                                                      data_size)
               : BMI088_ERR_NULL;
                                          ...
                                          bmi088_acc_softreset_reg_t const* reg)
{
    ...
    return bmi088_acc_bus_write_data(bmi088,
                                     BMI088_ACC_REG_ADDR_ACC_SOFTRESET,
                                     &data,
                                     sizeof(data));
}
                                         ...
                                         bmi088_acc_pwr_ctrl_reg_t const* reg)
{
    ...
    return bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_ACC_PWR_CTRL, &data, sizeof(data));
}
...
bmi088_err_t bmi088_get_acc_pwr_ctrl_reg(bmi088_t const* bmi088, bmi088_acc_pwr_ctrl_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_PWR_CTRL, &data, sizeof(data));
                                         ...
                                         bmi088_acc_pwr_conf_reg_t const* reg)
{
    ...
    return bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_ACC_PWR_CONF, &data, sizeof(data));
}
...
bmi088_err_t bmi088_get_acc_pwr_conf_reg(bmi088_t const* bmi088, bmi088_acc_pwr_conf_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_PWR_CONF, &data, sizeof(data));
                                          ...
                                          bmi088_acc_self_test_reg_t const* reg)
{
    ...
    return bmi088_acc_bus_write_data(bmi088,
                                     BMI088_ACC_REG_ADDR_ACC_SELF_TEST,
                                     &data,
                                     sizeof(data));
}
...
bmi088_err_t bmi088_get_acc_self_test_reg(bmi088_t const* bmi088, bmi088_acc_self_test_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_SELF_TEST, &data, sizeof(data));
                                             ...
                                             bmi088_acc_int_map_data_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_INT_MAP_DATA, &data, sizeof(data));
    ...
    err |= bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_INT_MAP_DATA, &data, sizeof(data));
}
                                             ...
                                             bmi088_acc_int2_io_ctrl_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_INT2_IO_CTRL, &data, sizeof(data));
    ...
    err |= bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_INT2_IO_CTRL, &data, sizeof(data));
                                             ...
                                             bmi088_acc_int1_io_ctrl_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_INT1_IO_CTRL, &data, sizeof(data));
    ...
    err |= bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_INT1_IO_CTRL, &data, sizeof(data));
                                            ...
                                            bmi088_acc_fifo_config_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_FIFO_CONFIG_0, data, sizeof(data));
    ...
    err |= bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_FIFO_CONFIG_0, data, sizeof(data));
                                         ...
                                         bmi088_acc_fifo_wtm_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_FIFO_WTM_0, data, sizeof(data));
    ...
    err |= bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_FIFO_WTM_0, data, sizeof(data));
                                           ...
                                           bmi088_acc_fifo_downs_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_FIFO_DOWNS, &data, sizeof(data));
...
bmi088_err_t bmi088_set_acc_range_reg(bmi088_t const* bmi088, bmi088_acc_range_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_RANGE, &data, sizeof(data));

    data &= ~0x03;

    data |= reg->acc_range & 0x03U;

    err |= bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_ACC_RANGE, &data, sizeof(data));
...
bmi088_err_t bmi088_set_acc_conf_reg(bmi088_t const* bmi088, bmi088_acc_conf_reg_t const* reg)
{
    ...
    return bmi088_acc_bus_write_data(bmi088, BMI088_ACC_REG_ADDR_ACC_CONF, &data, sizeof(data));
}
...
bmi088_err_t bmi088_get_acc_conf_reg(bmi088_t const* bmi088, bmi088_acc_conf_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_CONF, &data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_fifo_data_reg(bmi088_t const* bmi088, bmi088_acc_fifo_data_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_FIFO_DATA, &data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_temp_reg(bmi088_t const* bmi088, bmi088_acc_temp_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_TEMP_MSB, data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_int_stat_reg(bmi088_t const* bmi088, bmi088_acc_int_stat_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_INT_STAT, &data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_sensortime_reg(bmi088_t const* bmi088, bmi088_acc_sensortime_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_SENSORTIME_0, data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_z_reg(bmi088_t const* bmi088, bmi088_acc_z_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_Z_LSB, data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_y_reg(bmi088_t const* bmi088, bmi088_acc_y_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_Y_LSB, data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_x_reg(bmi088_t const* bmi088, bmi088_acc_x_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_X_LSB, data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_status_reg(bmi088_t const* bmi088, bmi088_acc_status_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_STATUS, &data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_err_reg(bmi088_t const* bmi088, bmi088_acc_err_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_ERR_REG, &data, sizeof(data));
...
bmi088_err_t bmi088_get_acc_chip_id_reg(bmi088_t const* bmi088, bmi088_acc_chip_id_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_acc_bus_read_data(bmi088, BMI088_ACC_REG_ADDR_ACC_CHIP_ID, &data, sizeof(data));
...
bmi088_err_t bmi088_get_gyro_fifo_data_reg(bmi088_t const* bmi088, bmi088_gyro_fifo_data_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_FIFO_DATA, &data, sizeof(data));
                                             ...
                                             bmi088_gyro_fifo_config_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_FIFO_CONFIG_0, data, sizeof(data));
    ...
    err |=
        bmi088_gyro_bus_write_data(bmi088, BMI088_GYRO_REG_ADDR_FIFO_CONFIG_0, data, sizeof(data));
                                           ...
                                           bmi088_gyro_self_test_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_SELF_TEST, &data, sizeof(data));
    ...
    err |= bmi088_gyro_bus_write_data(bmi088,
                                      BMI088_GYRO_REG_ADDR_GYRO_SELF_TEST,
                                      &data,
                                      sizeof(data));
                                                ...
                                                bmi088_gyro_fifo_ext_int_s_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_FIFO_EXT_INT_S, &data, sizeof(data));
    ...
    err |= bmi088_gyro_bus_write_data(bmi088,
                                      BMI088_GYRO_REG_ADDR_FIFO_EXT_INT_S,
                                      &data,
                                      sizeof(data));
                                             ...
                                             bmi088_gyro_fifo_wm_en_reg_t const* reg)
{
    ...
    return bmi088_gyro_bus_write_data(bmi088, BMI088_GYRO_REG_ADDR_FIFO_WM_EN, &data, sizeof(data));
}
                                             ...
                                             bmi088_gyro_fifo_wm_en_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_FIFO_WM_EN, &data, sizeof(data));
                                                  ...
                                                  bmi088_gyro_int3_int4_io_map_reg_t const* reg)
{
    ...
    bmi088_err_t err = bmi088_gyro_bus_read_data(bmi088,
                                                 BMI088_GYRO_REG_ADDR_INT3_INT4_IO_MAP,
                                                 &data,
                                                 sizeof(data));
                                                   ...
                                                   bmi088_gyro_int3_int4_io_conf_reg_t const* reg)
{
    ...
    bmi088_err_t err = bmi088_gyro_bus_read_data(bmi088,
                                                 BMI088_GYRO_REG_ADDR_INT3_INT4_IO_CONF,
                                                 &data,
                                                 sizeof(data));
                                          ...
                                          bmi088_gyro_int_ctrl_reg_t const* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_INT_CTRL, &data, sizeof(data));
    ...
    err |=
        bmi088_gyro_bus_write_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_INT_CTRL, &data, sizeof(data));
                                           ...
                                           bmi088_gyro_softreset_reg_t const* reg)
{
    ...
    return bmi088_gyro_bus_write_data(bmi088,
                                      BMI088_GYRO_REG_ADDR_GYRO_SOFTRESET,
                                      &data,
                                      sizeof(data));
}
...
bmi088_err_t bmi088_set_gyro_lpm1_reg(bmi088_t const* bmi088, bmi088_gyro_lpm1_reg_t const* reg)
{
    ...
    return bmi088_gyro_bus_write_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_LPM1, &data, sizeof(data));
}
...
bmi088_err_t bmi088_get_gyro_lpm1_reg(bmi088_t const* bmi088, bmi088_gyro_lpm1_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_LPM1, &data, sizeof(data));
                                           ...
                                           bmi088_gyro_bandwidth_reg_t const* reg)
{
    ...
    return bmi088_gyro_bus_write_data(bmi088,
                                      BMI088_GYRO_REG_ADDR_GYRO_BANDWIDTH,
                                      &data,
                                      sizeof(data));
}
...
bmi088_err_t bmi088_get_gyro_bandwidth_reg(bmi088_t const* bmi088, bmi088_gyro_bandwidth_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_BANDWIDTH, &data, sizeof(data));
...
bmi088_err_t bmi088_set_gyro_range_reg(bmi088_t const* bmi088, bmi088_gyro_range_reg_t const* reg)
{
    ...
    return bmi088_gyro_bus_write_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_RANGE, &data, sizeof(data));
}
...
bmi088_err_t bmi088_get_gyro_range_reg(bmi088_t const* bmi088, bmi088_gyro_range_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_RANGE, &data, sizeof(data));
                                             ...
                                             bmi088_gyro_fifo_status_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_FIFO_STATUS, &data, sizeof(data));
                                              ...
                                              bmi088_gyro_int_stat_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_INT_STAT, &data, sizeof(data));
...
bmi088_err_t bmi088_get_gyro_rate_z_reg(bmi088_t const* bmi088, bmi088_gyro_rate_z_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_RATE_Z_LSB, data, sizeof(data));
...
bmi088_err_t bmi088_get_gyro_rate_y_reg(bmi088_t const* bmi088, bmi088_gyro_rate_y_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_RATE_Y_LSB, data, sizeof(data));
...
bmi088_err_t bmi088_get_gyro_rate_x_reg(bmi088_t const* bmi088, bmi088_gyro_rate_x_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_RATE_X_LSB, data, sizeof(data));
...
bmi088_err_t bmi088_get_gyro_chip_id_reg(bmi088_t const* bmi088, bmi088_gyro_chip_id_reg_t* reg)
{
    ...
    bmi088_err_t err =
        bmi088_gyro_bus_read_data(bmi088, BMI088_GYRO_REG_ADDR_GYRO_CHIP_ID, &data, sizeof(data));
