...
typedef struct {
    void* acc_bus_user;
    bmi088_err_t (*acc_bus_init)(void*);
    bmi088_err_t (*acc_bus_deinit)(void*);
    bmi088_err_t (*acc_bus_write)(void*, uint8_t, uint8_t const*, size_t);
    bmi088_err_t (*acc_bus_read)(void*, uint8_t, uint8_t*, size_t);

    void* gyro_bus_user;
    bmi088_err_t (*gyro_bus_init)(void*);
    bmi088_err_t (*gyro_bus_deinit)(void*);
    bmi088_err_t (*gyro_bus_write)(void*, uint8_t, uint8_t const*, size_t);
    bmi088_err_t (*gyro_bus_read)(void*, uint8_t, uint8_t*, size_t);
} bmi088_interface_t;
